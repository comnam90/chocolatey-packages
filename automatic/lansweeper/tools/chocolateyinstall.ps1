...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url           = 'https://cdn.lansweeper.com/download/8.4.20/2/LansweeperSetup.exe'
  url64bit      = 'https://cdn.lansweeper.com/download/8.4.20/2/LansweeperSetup.exe'
  softwareName  = 'Lansweeper'
  checksum      = 'cdce0513c0d75cea7229d5f72584e7343af0a17c776017b64ed5425f0ff020ff'
  checksumType  = 'sha256'
  checksum64    = 'cdce0513c0d75cea7229d5f72584e7343af0a17c776017b64ed5425f0ff020ff'
