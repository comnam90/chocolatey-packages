...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url           = 'https://cdn.lansweeper.com/download/8.4.10/8/LansweeperSetup.exe'
  url64bit      = 'https://cdn.lansweeper.com/download/8.4.10/8/LansweeperSetup.exe'
  softwareName  = 'Lansweeper'
  checksum      = 'ce439ba5455987e9471816aee9fb4e5e7e557895f5c897b9575a7df5c9c0ede4'
  checksumType  = 'sha256'
  checksum64    = 'ce439ba5455987e9471816aee9fb4e5e7e557895f5c897b9575a7df5c9c0ede4'
