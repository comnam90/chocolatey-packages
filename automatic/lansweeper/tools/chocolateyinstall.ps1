...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url           = 'https://cdn.lansweeper.com/download/8.2.130/4/LansweeperSetup.exe'
  url64bit      = 'https://cdn.lansweeper.com/download/8.2.130/4/LansweeperSetup.exe'
  softwareName  = 'Lansweeper'
  checksum      = 'bfee01b4283819a7b5944c2e4e9719c673bb62b1e5e6246a1b221688a7040f5a'
  checksumType  = 'sha256'
  checksum64    = 'bfee01b4283819a7b5944c2e4e9719c673bb62b1e5e6246a1b221688a7040f5a'
