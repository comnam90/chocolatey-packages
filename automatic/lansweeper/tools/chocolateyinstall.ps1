...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url           = 'https://cdn.lansweeper.com/download/8.1.120/3/LansweeperSetup.exe'
  url64bit      = 'https://cdn.lansweeper.com/download/8.1.120/3/LansweeperSetup.exe'
  softwareName  = 'Lansweeper'
  checksum      = 'ca9883e6260166679279d5fd38a1e974eddd7390cd5e801ee8692eb0b1106352'
  checksumType  = 'sha256'
  checksum64    = 'ca9883e6260166679279d5fd38a1e974eddd7390cd5e801ee8692eb0b1106352'
