...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url           = 'https://cdn.lansweeper.com/download/8.2.100/11/LansweeperSetup.exe'
  url64bit      = 'https://cdn.lansweeper.com/download/8.2.100/11/LansweeperSetup.exe'
  softwareName  = 'Lansweeper'
  checksum      = 'd9f85baaffb9f35e968435c4b6fa302b08284f9ebd4ddd74aecd9577961bb40c'
  checksumType  = 'sha256'
  checksum64    = 'd9f85baaffb9f35e968435c4b6fa302b08284f9ebd4ddd74aecd9577961bb40c'
