...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url           = 'https://cdn.lansweeper.com/download/8.1.120/4/LansweeperSetup.exe'
  url64bit      = 'https://cdn.lansweeper.com/download/8.1.120/4/LansweeperSetup.exe'
  softwareName  = 'Lansweeper'
  checksum      = 'ed06804825fc363e4e08a51e34959c36445f0b4b865363fe4e8d00399acdeb31'
  checksumType  = 'sha256'
  checksum64    = 'ed06804825fc363e4e08a51e34959c36445f0b4b865363fe4e8d00399acdeb31'
