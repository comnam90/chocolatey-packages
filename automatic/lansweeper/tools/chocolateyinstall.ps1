...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url           = 'https://cdn.lansweeper.com/download/8.0.130/38/LansweeperSetup.exe'
  url64bit      = 'https://cdn.lansweeper.com/download/8.0.130/38/LansweeperSetup.exe'
  softwareName  = 'Lansweeper'
  checksum      = '62bad1505aa41b41fa59cebe8c85a8b7ae8eb80bc4719b60785780d2fd0653b5'
  checksumType  = 'sha256'
  checksum64    = '62bad1505aa41b41fa59cebe8c85a8b7ae8eb80bc4719b60785780d2fd0653b5'
