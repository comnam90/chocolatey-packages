...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url           = 'https://cdn.lansweeper.com/download/8.2.200/15/LansweeperSetup.exe'
  url64bit      = 'https://cdn.lansweeper.com/download/8.2.200/15/LansweeperSetup.exe'
  softwareName  = 'Lansweeper'
  checksum      = '01553850a790250e48a50bee952e75cc31ac578a6e424c9e4e590121c267824e'
  checksumType  = 'sha256'
  checksum64    = '01553850a790250e48a50bee952e75cc31ac578a6e424c9e4e590121c267824e'
