...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url           = 'https://cdn.lansweeper.com/download/8.2.110/1/LansweeperSetup.exe'
  url64bit      = 'https://cdn.lansweeper.com/download/8.2.110/1/LansweeperSetup.exe'
  softwareName  = 'Lansweeper'
  checksum      = 'dcaf8502670602762aa08279442e00deadc51d3e3792748d3b4a61ddcb5a27f6'
  checksumType  = 'sha256'
  checksum64    = 'dcaf8502670602762aa08279442e00deadc51d3e3792748d3b4a61ddcb5a27f6'
