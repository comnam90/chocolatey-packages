...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url           = 'https://cdn.lansweeper.com/download/8.1.110/1/LansweeperSetup.exe'
  url64bit      = 'https://cdn.lansweeper.com/download/8.1.110/1/LansweeperSetup.exe'
  softwareName  = 'Lansweeper'
  checksum      = 'a05aeeb4c9c675c565789748124f1e010ef079a2d0b0d4467f489ce91109ed07'
  checksumType  = 'sha256'
  checksum64    = 'a05aeeb4c9c675c565789748124f1e010ef079a2d0b0d4467f489ce91109ed07'
