...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url           = 'https://cdn.lansweeper.com/download/8.0.130/37/LansweeperSetup.exe'
  url64bit      = 'https://cdn.lansweeper.com/download/8.0.130/37/LansweeperSetup.exe'
  softwareName  = 'Lansweeper'
  checksum      = '4f82d73e6cd7ed025e3ef6906551723a9f54cdd7247c860204988ce4546b1329'
  checksumType  = 'sha256'
  checksum64    = '4f82d73e6cd7ed025e3ef6906551723a9f54cdd7247c860204988ce4546b1329'
